...
<script>
  ...
  <body>
    ...
    <script>
            ...
            window['SERVER_CHANNEL_URL'] = "ws://localhost:6009/storybook-server-channel";
    ...
    <script src="vendors-node_modules_storybook_addon-actions_manager_js-node_modules_storybook_addon-backgrou-f2b82d.manager.bundle.js"></script>
